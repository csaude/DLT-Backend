...
public class AgywPrevQueries {
	...
	public static final String AGYW_PREV = "select id, beneficiary_id, nui, current_age, date_of_birth, district_id, vblt_is_student, vblt_sexually_active, date_created, \n"
			...
			+ "					   completion_status, "
			+ "                    IFNULL(general_vulnerabilities,0) + IFNULL(specific_vulnerabilities,0) AS vulnerabilities, \n" 
			+ "                    sum(case\n"
			...
			+ "                    sum(case\n"
			+ "                    when (vblt_is_student=1 and sub_service_id in (169,170,176)\n"
			+ "                        or vblt_is_student=0 and sub_service_id in (164)) then 1\n"
			+ "                    else 0\n" 
			+ "                    end) mandatory_social_assetss,\n" 
			+ "                    sum(case\n"
			+ "                    when (vblt_is_student=1 and sub_service_id in (184,185,186,187,188,189,190,191,192,193,194,195)\n"
			+ "                        or vblt_is_student=0 and sub_service_id in (179,180,181,182,183)) then 1\n"
			+ "                    else 0\n" 
			+ "                    end) mandatory_hiv_prevention,\n" 
			+ "                    sum(case\n"
			+ "                    when (vblt_is_student=1 and sub_service_id in (207,208,209)\n"
			+ "                        or vblt_is_student=0 and sub_service_id in (196,197,198,199,200)) then 1\n"
			+ "                    else 0\n" 
			+ "                    end) mandatory_violence_prevention,\n"
			+ "                    sum(case\n"
			...
			+ "                    sum(case\n"
			+ "                        when sub_service_id in (201,202,203,204,205,206) then 1\n"
			+ "                        else 0\n" 
			+ "                    end) guiao_hiv_sessions,\n"
			+ "                    sum(case\n"
			+ "                        when sub_service_id in (210,211,212) then 1\n"
			+ "                        else 0\n" 
			+ "                    end) guiao_gbv_sessions,\n"
			+ "                    sum(case\n" 
			...
			+ "                    sum(case\n" 
			+ "                        when sub_service_id in (214,235,236,237,238,239,240,241,242,243,244,245,246,247,248,249) then 1\n"
			+ "                        else 0\n" 
			...
			+ "                    sum(case\n" 
			+ "                        when sub_service_id in (236,237,238,239,240,241,242) then 1\n"
			+ "                        else 0\n" 
			+ "                    end) siyakha_light,\n"
			+ "                    sum(case\n" 
			+ "                        when sub_service_id in (243,244,245,246,247,248,249,250,251) then 1\n"
			+ "                        else 0\n" 
			+ "                    end) siyakha_comprehensive,\n"
	...
	public static final String SIMPLIFIED_AGYW_PREV = "select id, beneficiary_id, nui, current_age, date_of_birth, district_id, vblt_is_student, vblt_sexually_active, date_created, \n"
			...
			+ "							if(current_age = 20  and min(datediff(service_date,date_of_birth)/30) between 180 and 237,2,current_age_band)) current_age_band,\n"
			+ "					   completion_status, "
			+ "                    coalesce(general_vulnerabilities,0) + coalesce(specific_vulnerabilities,0) vulnerabilities, \n" 
			+ "                    sum(case\n"
	...
	public static final String AGYW_PREV_BENEFICIARIES = ""
			+ "select  provincia,\n"
			+ "	distrito,\n"
			+ "	onde_mora,\n"
			+ "	ponto_entrada,\n"
			...
			+ "		coalesce(v.general_vulnerabilities,0) + coalesce(v.specific_vulnerabilities,0) vulnerabilidades,\n"
			...
			+ "	where v.beneficiary_id in (:beneficiaries_ids)\n"
	...
	public static final String NEWLY_ENROLLED_AGYW_AND_SERVICES= ""
			...
			+ "			or ((v.vblt_house_sustainer = 1 or v.vblt_married_before = 1 or v.vblt_pregnant_before = 1 or v.vblt_children = 1 or v.vblt_sexual_exploitation_trafficking_victim = 1 or v.vblt_is_migrant = 1) and v.current_age < 20)\n"
	...
	public static final String Beneficiaries_No_Vulnerabilities= ""
			...
			+ "		and b.vblt_is_migrant is null and b.vblt_sexual_exploitation_trafficking_victim is null\n"
	...
	public static final String NEWLY_ENROLLED_AGYW_AND_SERVICES_SUMMARY= ""
			...
			+ "		if(v.current_age < 20 and v.vblt_sexual_exploitation_trafficking_victim=1,1,0) +\n"
